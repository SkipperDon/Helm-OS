...
| `deployment/docs/V09995_DISCUSSION_PLAN.md` | **[NEW — S92 2026-06-23]** v0.9.9.5 Research & Discussion Backlog. Captures 10 research topics discussed across sessions S76–S91 that are not yet approved for build: WiBoat WiFi CSI radar (DESIGN COMPLETE), SafeHelm collision avoidance (DESIGN COMPLETE), Sail-O-Vision collaboration (RESEARCH), D3K-Lite OpenPlotter addon (AWAITING COMMUNITY), signalk-forward-watch v0.2.4, AAO data collection system, Mobile PWA remaining features, pypilot integration (DEFERRED), research paper submission, AAO methodology evolution. Includes prioritization table. |
